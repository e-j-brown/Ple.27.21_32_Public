...
apply_rounding <- function(df) {
  ...
  df[] <- lapply(df, function(col) {
    if (is.numeric(col)) {
      # Apply rounding rules to numeric columns
...
kable(tabsum,
      caption = paste0("Estimated recruitment, spawning stock biomass (SSB), total stock biomass (TSB) and fishing mortality for ages 3-5 of ple.27.21-23.")) 
```
