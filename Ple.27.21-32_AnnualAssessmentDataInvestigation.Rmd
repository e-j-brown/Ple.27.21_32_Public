...
totCatchNo <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/cn.dat")/1000
totcatchMeanWeight <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/cw.dat")
totdisMeanWeight <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/dw.dat")
totdf <- 1-read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/lf_frac.dat")
...
cn_full <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/cn.dat")/1000
cn_surv <- read.ices("Assessment Input/StockAnnex/cn_mid.dat")/1000
cw_full <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/cw.dat")
dw_surv <- read.ices("Assessment Input/StockAnnex/dw_mid.dat")
dw_full <- read.ices("Assessment Input/AlternateModel_NoDiscardSurvival/dw.dat")
