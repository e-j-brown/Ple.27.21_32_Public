...
kable(IC_agg_temp,
      caption = paste0("Catches and landings by management area in ", DataYear, " (tonnes). _Used for the stock splitting table_."),
      digits = 2)
```


- The catch from all subdivisions combined in `r (DataYear)` was `r sum(ic_clean[ic_clean$Year == DataYear, "CATON"])` tonnes.  
