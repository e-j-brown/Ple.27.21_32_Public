...
The model selected for creating forecasts and advice, this year, is called [ple.27.21.32_WGBFAS_CURRENT](https://stockassessment.org/setStock.php?stock=ple.27.21.32_WGBFAS_CURRENT) and is available from [stockassessment.org](https://stockassessment.org).
...
### Fmsy
```{r ForecastFmsy, message=FALSE, warning=FALSE}
set.seed(12345)
...
### Zero Fishing
```{r ForecastF0, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
### Fmsy (lower)
```{r ForecastFmsyLower, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
### Fmsy (upper)
```{r ForecastFmsyUpper, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
### Status Quo Fishing Pressure
```{r ForecastSQ, message=FALSE, warning=FALSE}
set.seed(12345)
...
```{r ForecastFpa, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                              fscale=c(1,1,NA,NA),
...
### Fishing at Flim
```{r ForecastFlim, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
```{r ForecastSSB_Btrigger, message=FALSE, warning=FALSE, eval=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
```{r ForecastSSB_Bpa, message=FALSE, warning=FALSE, eval=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
```{r ForecastSSB_Blim, message=FALSE, warning=FALSE, eval=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
...
```{r ForecastSSB_AdviceYear, message=FALSE, warning=FALSE, eval=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
                               nextssb=c(NA,NA,
...
```{r ForecastCatch_20pc, message=FALSE, warning=FALSE}
set.seed(12345)
FC[[length(FC)+1]] <- forecast(fit_CURRENT,
                               fscale=c(1,1,NA,NA),
