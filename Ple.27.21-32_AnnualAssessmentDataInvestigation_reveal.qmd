...
Use the menu button (bottom-left) or these links to navigate sections.

- [Manual settings for figure formatting](#/manual-settings-for-figure-formatting)
- [ebpal <- c("#2F3EEA", "#1FD082", "#030F4F", "#F6D04D", "#FC7634", "#F7BBB1", "#E83F48", "#008835", "#79238E")](#/ebpal-c-2f3eea-1fd082-030f4f-f6d04d-fc7634-f7bbb1-e83f48-008835-79238e)
- [Introduction](#/introduction)
- [isFinal <- TRUE](#/isfinal-true)
- [Assessment Input Data](#/assessment-input-data)
- [ic_raw$CatchCategory <- as.factor(gsub(pattern = "BMS landing",](#/ic-raw-catchcategory-as-factor-gsub-pattern-bms-landing)
- [replacement = "BMS",](#/replacement-bms)
- [x = ic_raw$CatchCategory))](#/x-ic-raw-catchcategory)
- [Update HistLand](#/update-histland)
- [landings2018 <- aggregate(CATON~Area+Country+Year,](#/landings2018-aggregate-caton-area-country-year)
- [data = ic_clean[ic_clean$Year == "2018" & ic_clean$CatchCategory != "Discards", ],](#/data-ic-clean-ic-clean-year-2018-ic-clean-catchcategory-discards)
- [FUN = sum)](#/fun-sum)
- [landings2018$Year <- as.factor(as.character(2018))](#/landings2018-year-as-factor-as-character-2018)
- [names(landings2018)[names(landings2018) == "CATON"] <- "Landings"](#/names-landings2018-names-landings2018-caton-landings)
- [landings2019 <- aggregate(CATON~Area+Country,](#/landings2019-aggregate-caton-area-country)
- [data = ic_clean[ic_clean$Year == "2019" & ic_clean$CatchCategory != "Discards", ],](#/data-ic-clean-ic-clean-year-2019-ic-clean-catchcategory-discards)
- [landings2019$Year <- as.factor(as.character(2019))](#/landings2019-year-as-factor-as-character-2019)
- [names(landings2019)[names(landings2019) == "CATON"] <- "Landings"](#/names-landings2019-names-landings2019-caton-landings)
- [landings2020 <- aggregate(CATON~Area+Country,](#/landings2020-aggregate-caton-area-country)
- [data = ic_clean[ic_clean$Year == "2020" & ic_clean$CatchCategory != "Discards", ],](#/data-ic-clean-ic-clean-year-2020-ic-clean-catchcategory-discards)
- [landings2020$Year <- as.factor(as.character(2020))](#/landings2020-year-as-factor-as-character-2020)
- [names(landings2020)[names(landings2020) == "CATON"] <- "Landings"](#/names-landings2020-names-landings2020-caton-landings)
- [landings2021 <- aggregate(CATON~Area+Country,](#/landings2021-aggregate-caton-area-country)
- [data = ic_clean[ic_clean$Year == "2021" & ic_clean$CatchCategory != "Discards", ],](#/data-ic-clean-ic-clean-year-2021-ic-clean-catchcategory-discards)
- [landings2021$Year <- as.factor(as.character(2021))](#/landings2021-year-as-factor-as-character-2021)
- [names(landings2021)[names(landings2021) == "CATON"] <- "Landings"](#/names-landings2021-names-landings2021-caton-landings)
- [HistLand <- rbind(HistLand_raw, landings2018, landings2019, landings2020, landings2021)](#/histland-rbind-histland-raw-landings2018-landings2019-landings2020-landings2021)
- [Figure 3 Short term Landings by country](#/figure-3-short-term-landings-by-country)
- [IC_agg_temp$CATON <- IC_agg_temp$CATON.kg/1000](#/ic-agg-temp-caton-ic-agg-temp-caton-kg-1000)
- [Figure 4 Landings and TAC by MgmtArea](#/figure-4-landings-and-tac-by-mgmtarea)
- [Figure 5 Landings in 22](#/figure-5-landings-in-22)
- [Figure 6 Landings in 23](#/figure-6-landings-in-23)
- [Figure 5 Landings in 22:32](#/figure-5-landings-in-22-32)
- [Figure 7 Landings in all areas by country](#/figure-7-landings-in-all-areas-by-country)
- [TACall <- tac_raw[tac_raw$Year %in% c(2002:DataYear),]](#/tacall-tac-raw-tac-raw-year-in-c-2002-datayear)
- [Figure of landings by gear type](#/figure-of-landings-by-gear-type)
- [Figure Catch by catch category (all areas, all countries)](#/figure-catch-by-catch-category-all-areas-all-countries)
- [catchNumLng$Year <- as.factor(as.character(catchNumLng$Year))](#/catchnumlng-year-as-factor-as-character-catchnumlng-year)
- [Figures of discard ratios](#/figures-of-discard-ratios)
- [plt_disrat_area <- ggplot() +](#/plt-disrat-area-ggplot)
- [geom_col(data = disrat,](#/geom-col-data-disrat)
- [mapping = aes(x = Year,](#/mapping-aes-x-year)
- [y = DiscardRatio,](#/y-discardratio)
- [fill = Area),](#/fill-area)
- [position = "dodge") +](#/position-dodge)
- [scale_fill_manual(values = ebpal) +](#/scale-fill-manual-values-ebpal)
- [theme_bw() +](#/theme-bw)
- [theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))](#/theme-axis-text-x-element-text-angle-90-hjust-1-vjust-0-5)
- [Prepare data](#/prepare-data)
- [disrat$Year <- as.factor(as.character(disrat$Year))](#/disrat-year-as-factor-as-character-disrat-year)
- [Figure for advice after 2021: Discard Ratios and Landings over time](#/figure-for-advice-after-2021-discard-ratios-and-landings-over-time)
- [Figure of landings and discard ratios over time](#/figure-of-landings-and-discard-ratios-over-time)
- [Prep data](#/prep-data)
- [disrat[is.na(disrat$CATON.BMS), "CATON.BMS"] <- 0](#/disrat-is-na-disrat-caton-bms-caton-bms-0)
- [Figure Discard Ratios by Country](#/figure-discard-ratios-by-country)
- [Figure Discards/landings of DataYear by quarter and gear](#/figure-discards-landings-of-datayear-by-quarter-and-gear)
- [Reshape to make Quarters wide](#/reshape-to-make-quarters-wide)
- [Data agreggation](#/data-agreggation)
- [Discard Ratios all together](#/discard-ratios-all-together)
- [Aggregate catches in a format for use in the stock splitting table](#/aggregate-catches-in-a-format-for-use-in-the-stock-splitting-table)
- [Surviving discard fractions from discards and total catch - from DataCoordination Lowestoft file](#/surviving-discard-fractions-from-discards-and-total-catch-from-datacoordination-lowestoft-file)
- [Aggregate and format Landings and Discards for Named Countries & "Others"](#/aggregate-and-format-landings-and-discards-for-named-countries-others)
- [IC_agg_temp2 <- ic_clean[ic_clean$CatchCategory %in% c("BMS landing", "BMS"), ]](#/ic-agg-temp2-ic-clean-ic-clean-catchcategory-in-c-bms-landing-bms)
- [IC_agg_temp2[IC_agg_temp2$CatchCategory == "BMS landing", "CATON"] <- IC_agg_temp2[IC_agg_temp2$CatchCategory == "BMS landing", "OfficialLandings.kg"]/1000](#/ic-agg-temp2-ic-agg-temp2-catchcategory-bms-landing-caton-ic-agg-temp2-ic-agg-temp2-catchcategory-bms-landing-officiallandings-kg-1000)
- [IC_agg_temp2 <- aggregate(CATON~MgmtArea+Year+,](#/ic-agg-temp2-aggregate-caton-mgmtarea-year)
- [data = IC_agg_temp2,](#/data-ic-agg-temp2)
- [FUN = "sum")](#/fun-sum)
- [IC_agg_temp2$CountryCatch <- rep("BMS", nrow(IC_agg_temp2))](#/ic-agg-temp2-countrycatch-rep-bms-nrow-ic-agg-temp2)
- [IC_agg_temp <- rbind(IC_agg_temp, IC_agg_temp2)](#/ic-agg-temp-rbind-ic-agg-temp-ic-agg-temp2)
- [adctchtble <- as.data.frame(lapply(adctchtble, FUN = "as.numeric"))](#/adctchtble-as-data-frame-lapply-adctchtble-fun-as-numeric)
- [subtract BMS from Discards & Restructure](#/subtract-bms-from-discards-restructure)
- [Add Annual Totals](#/add-annual-totals)
- [Do formating](#/do-formating)
- [Data wrangling and calculation of Raised/imported sampled/Estimated catches for Current Year](#/data-wrangling-and-calculation-of-raised-imported-sampled-estimated-catches-for-current-year)
- [Figure of sampling coverage for DataYear](#/figure-of-sampling-coverage-for-datayear)
- [Tabulate for presentation](#/tabulate-for-presentation)
- [Data wrangling](#/data-wrangling)
- [Data prep](#/data-prep)
- [Figure 12 Survey Tuning Indices over time](#/figure-12-survey-tuning-indices-over-time)
- [source(file = "SupportingScripts/01_DatrasDownloads.R")](#/source-file-supportingscripts-01-datrasdownloads-r)
- [Clean up data environment](#/clean-up-data-environment)
- [rm(list = c("r"))](#/rm-list-c-r)
- [First prepare maturity data for calculating MOs ----](#/first-prepare-maturity-data-for-calculating-mos)
- [Select data for use in this script by removing rows without relevant observations](#/select-data-for-use-in-this-script-by-removing-rows-without-relevant-observations)
- [Re-code the spawning status so that they are all uniform and simplified from maturity stage to binary](#/re-code-the-spawning-status-so-that-they-are-all-uniform-and-simplified-from-maturity-stage-to-binary)
- [Sort the data](#/sort-the-data)
- [Calculate number of fish (mature or immature) by year+sex+age+LngtClass](#/calculate-number-of-fish-mature-or-immature-by-year-sex-age-lngtclass)
- [Calculate length frequencies from at sea observations ----](#/calculate-length-frequencies-from-at-sea-observations)
- [Establish parameters for calculations](#/establish-parameters-for-calculations)
- [Make table for length freq data](#/make-table-for-length-freq-data)
- [Fill the table](#/fill-the-table)
- [Replace NA with 0](#/replace-na-with-0)
- [Calculate proportions from sampled data (observations) ----](#/calculate-proportions-from-sampled-data-observations)
- [Make a table for number of fish sampled, for spawner and non-spawner](#/make-a-table-for-number-of-fish-sampled-for-spawner-and-non-spawner)
- [Fill the table with how many fish have been sampled (mature, immature)](#/fill-the-table-with-how-many-fish-have-been-sampled-mature-immature)
- [Total number of fish sampled (immature+mature)  by length](#/total-number-of-fish-sampled-immature-mature-by-length)
- [Total number of fish sampled, by age](#/total-number-of-fish-sampled-by-age)
- [Raise proportions to unsampled strata ----](#/raise-proportions-to-unsampled-strata)
- [Make tables](#/make-tables)
- [Numbers at sea by maturity class by length](#/numbers-at-sea-by-maturity-class-by-length)
- [Sum of numbers at sea, by maturity class, by ages (sum over length-groups) - generate tables](#/sum-of-numbers-at-sea-by-maturity-class-by-ages-sum-over-length-groups-generate-tables)
- [Calculate the sex ratio ----](#/calculate-the-sex-ratio)
- [Calculate Maturity Ogives ----](#/calculate-maturity-ogives)
- [Generate tables for female, male and combined ogives](#/generate-tables-for-female-male-and-combined-ogives)
- [Female mature](#/female-mature)
- [Male mature](#/male-mature)
- [Combsex mature](#/combsex-mature)
- [Combined Sexes reshape and calculate means +/- 95%CI for plotting ----](#/combined-sexes-reshape-and-calculate-means-95-ci-for-plotting)
- [Female Only reshape and calculate means +/- 95%CI for plotting ----](#/female-only-reshape-and-calculate-means-95-ci-for-plotting)
- [saveRDS(fmo, file = "Data/BiologicalData/Ple.27.21-32_MaturitiesFemaleLong_1999-AssYear.RDS")](#/saverds-fmo-file-data-biologicaldata-ple-27-21-32-maturitiesfemalelong-1999-assyear-rds)
- [saveRDS(fmstdr, file("Data/BiologicalData/Ple.27.21-32_MaturitiesFemaleAveStdErr_15yr.RDS"))](#/saverds-fmstdr-file-data-biologicaldata-ple-27-21-32-maturitiesfemaleavestderr-15yr-rds)
- [saveRDS(rfmstdr, file("Data/BiologicalData/Ple.27.21-32_MaturitiesFemaleAveStdErr_2002-AssYear.RDS"))](#/saverds-rfmstdr-file-data-biologicaldata-ple-27-21-32-maturitiesfemaleavestderr-2002-assyear-rds)
- [Male Only reshape and calculate means +/- 95%CI for plotting ----](#/male-only-reshape-and-calculate-means-95-ci-for-plotting)
- [saveRDS(mmo, file = "Data/BiologicalData/Ple.27.21-32_MaturitiesMaleLong_1999-AssYear.RDS")](#/saverds-mmo-file-data-biologicaldata-ple-27-21-32-maturitiesmalelong-1999-assyear-rds)
- [saveRDS(mmstdr, file("Data/BiologicalData/Ple.27.21-32_MaturitiesMaleAveStdErr_15yr.RDS"))](#/saverds-mmstdr-file-data-biologicaldata-ple-27-21-32-maturitiesmaleavestderr-15yr-rds)
- [saveRDS(rmmstdr, file("Data/BiologicalData/Ple.27.21-32_MaturitiesMaleAveStdErr_2002-AssYear.RDS"))](#/saverds-rmmstdr-file-data-biologicaldata-ple-27-21-32-maturitiesmaleavestderr-2002-assyear-rds)
- [Combined Sexes Sliding window averages ----](#/combined-sexes-sliding-window-averages)
- [mo5sw[mo5sw$year == 2002, -ncol(mo5sw)] <- mo5sw[mo5sw$year == 2003, -ncol(mo5sw)]](#/mo5sw-mo5sw-year-2002-ncol-mo5sw-mo5sw-mo5sw-year-2003-ncol-mo5sw)
- [Clean Data Environment](#/clean-data-environment)
- [kable(mo[mo$year == "Running Mean", c("AgeN", "PropMat") ],](#/kable-mo-mo-year-running-mean-c-agen-propmat)
- [kable(rmstdrder,](#/kable-rmstdrder)
- [caption = paste0("Maturity Ogives of Ple.27.21-32, using the stock annex method from the previous Ple.27.21-23.  Values are timeseries means of both sexes for the period 2002-", DataYear),](#/caption-paste0-maturity-ogives-of-ple-27-21-32-using-the-stock-annex-method-from-the-previous-ple-27-21-23-values-are-timeseries-means-of-both-sexes-for-the-period-2002-datayear)
- [digits = 2)](#/digits-2)
- [mo3orderwSAM <- mo3orderw[mo3orderw$year %in% c(2002:(DataYear+1)), ]](#/mo3orderwsam-mo3orderw-mo3orderw-year-in-c-2002-datayear-1)
- [for(i in 1:ncol(mo3orderwSAM)){](#/for-i-in-1-ncol-mo3orderwsam)
- [for(j in 1:nrow(mo3orderwSAM)){](#/for-j-in-1-nrow-mo3orderwsam)
- [mo3orderwSAM[j, i] <- ifelse(is.na(mo3orderwSAM[j, i]), -9, mo3orderwSAM[j, i])](#/mo3orderwsam-j-i-ifelse-is-na-mo3orderwsam-j-i-9-mo3orderwsam-j-i)
- [}](#/)
- [kable(mo3orderw,](#/kable-mo3orderw)
- [caption = paste0("Maturity Ogives of Ple.27.21-32, using a 3 year sliding window mean approach.  Values are timeseries means of the whole timeseries, 2002:", DataYear+1),](#/caption-paste0-maturity-ogives-of-ple-27-21-32-using-a-3-year-sliding-window-mean-approach-values-are-timeseries-means-of-the-whole-timeseries-2002-datayear-1)
- [moRawOrderSAM <- moRawOrder[moRawOrder$year %in% c(2002:(DataYear+1)), ]](#/morawordersam-moraworder-moraworder-year-in-c-2002-datayear-1)
- [for(i in 1:ncol(moRawOrderSAM)){](#/for-i-in-1-ncol-morawordersam)
- [for(j in 1:nrow(moRawOrderSAM)){](#/for-j-in-1-nrow-morawordersam)
- [moRawOrderSAM[j, i] <- ifelse(is.na(moRawOrderSAM[j, i]), -9, moRawOrderSAM[j, i])](#/morawordersam-j-i-ifelse-is-na-morawordersam-j-i-9-morawordersam-j-i)
- [mo5orderwSAM <- mo5orderw[mo5orderw$year %in% c(2002:(DataYear+1)), ]](#/mo5orderwsam-mo5orderw-mo5orderw-year-in-c-2002-datayear-1)
- [for(i in 1:ncol(mo5orderwSAM)){](#/for-i-in-1-ncol-mo5orderwsam)
- [for(j in 1:nrow(mo5orderwSAM)){](#/for-j-in-1-nrow-mo5orderwsam)
- [mo5orderwSAM[j, i] <- ifelse(is.na(mo5orderwSAM[j, i]), -9, mo5orderwSAM[j, i])](#/mo5orderwsam-j-i-ifelse-is-na-mo5orderwsam-j-i-9-mo5orderwsam-j-i)
- [for(i in 2:ncol(mo2w)){](#/for-i-in-2-ncol-mo2w)
- [for(j in 2:nrow(mo2w)){](#/for-j-in-2-nrow-mo2w)
- [mo2w[j, i] <- ifelse(is.na(mo2w[j, i]), -9, mo2w[j, i])](#/mo2w-j-i-ifelse-is-na-mo2w-j-i-9-mo2w-j-i)
- [mo2w[j, i] <- ifelse((mo2w[j, i]>1), 1, mo2w[j, i])](#/mo2w-j-i-ifelse-mo2w-j-i-1-1-mo2w-j-i)
- [kable(mo2w[mo2w$year >= 2002, ],](#/kable-mo2w-mo2w-year-2002)
- [caption = paste0("Maturity Ogives of Ple.27.21-32, using spline smoothed estimates from survey observations for the whole timeseries, 2002:", DataYear+1),](#/caption-paste0-maturity-ogives-of-ple-27-21-32-using-spline-smoothed-estimates-from-survey-observations-for-the-whole-timeseries-2002-datayear-1)
- [Figure showing 3 year sliding window MO vs others](#/figure-showing-3-year-sliding-window-mo-vs-others)
- [Figure showing 5 year sliding window MO vs others](#/figure-showing-5-year-sliding-window-mo-vs-others)
- [swalba <- melt(setDT(WAA_combsex), id.vars = "year", variable.name = "Age", value.name = "MeanWeight")](#/swalba-melt-setdt-waa-combsex-id-vars-year-variable-name-age-value-name-meanweight)
- [mo5swL_1zero$Age <- factor(as.character(mo5swL_1zero$AgeN), levels = as.character(sort(unique(mo5swL_1zero$AgeN))))](#/mo5swl-1zero-age-factor-as-character-mo5swl-1zero-agen-levels-as-character-sort-unique-mo5swl-1zero-agen)
- [Subset processed exchange data ----](#/subset-processed-exchange-data)
- [Select the SD and quarter](#/select-the-sd-and-quarter)
- [Summarise and aggregate data ----](#/summarise-and-aggregate-data)
- [Add 1 to all rows just to be able to count the fish](#/add-1-to-all-rows-just-to-be-able-to-count-the-fish)
- [Round the length class](#/round-the-length-class)
- [How many fish we have](#/how-many-fish-we-have)
- [Aggregate number of fish and average weight in samples](#/aggregate-number-of-fish-and-average-weight-in-samples)
- [Length Frequencies "at sea" ----](#/length-frequencies-at-sea)
- [Set parameters for data](#/set-parameters-for-data)
- [Make tables for length freq data](#/make-tables-for-length-freq-data)
- [replace NA with 0](#/replace-na-with-0)
- [Summary of sampled fish: weight by length and by age ----](#/summary-of-sampled-fish-weight-by-length-and-by-age)
- [Number of samples](#/number-of-samples)
- [Number of fish sampled by length class:](#/number-of-fish-sampled-by-length-class)
- [Number of fish sampled by age:](#/number-of-fish-sampled-by-age)
- [Sex Ratios ----](#/sex-ratios)
- [Fill tables](#/fill-tables)
- [Full survey numbers for raising ----](#/full-survey-numbers-for-raising)
- [Make Tables](#/make-tables)
- [Sum of numbers over age-groups, by length](#/sum-of-numbers-over-age-groups-by-length)
- [Sum of numbers over length-groups, by age](#/sum-of-numbers-over-length-groups-by-age)
- [Raise proportions to full survey numbers ----](#/raise-proportions-to-full-survey-numbers)
- [Sum weights by age over length classes](#/sum-weights-by-age-over-length-classes)
- [Stock mean weight at age ----](#/stock-mean-weight-at-age)
- [Reshape WAA data and calculate means +/- 95%CI  for plotting  ----](#/reshape-waa-data-and-calculate-means-95-ci-for-plotting)
- [Wide to long format](#/wide-to-long-format)
- [Calculate std err around the above mean 1999:2019](#/calculate-std-err-around-the-above-mean-1999-2019)
- [Calculate std err around the above 3 year mean](#/calculate-std-err-around-the-above-3-year-mean)
- [Standard error of 1999 -> mean](#/standard-error-of-1999-mean)
- [Combine all years, 2002 -> mean and 15 year mean into one object](#/combine-all-years-2002-mean-and-15-year-mean-into-one-object)
- [save results](#/save-results)
- [save_as_lowestoft Annaul Estimates](#/save-as-lowestoft-annaul-estimates)
- [for(i in 1:ncol(WAA_combsexSAM)){](#/for-i-in-1-ncol-waa-combsexsam)
- [for(j in 1:nrow(WAA_combsexSAM)){](#/for-j-in-1-nrow-waa-combsexsam)
- [WAA_combsexSAM[j, i] <- ifelse(is.na(WAA_combsexSAM[j, i]), -9, WAA_combsexSAM[j, i])](#/waa-combsexsam-j-i-ifelse-is-na-waa-combsexsam-j-i-9-waa-combsexsam-j-i)
- [for(i in 1:ncol(sw3swSAM)){](#/for-i-in-1-ncol-sw3swsam)
- [for(j in 1:nrow(sw3swSAM)){](#/for-j-in-1-nrow-sw3swsam)
- [sw3swSAM[j, i] <- ifelse(is.na(sw3swSAM[j, i]), -9, sw3swSAM[j, i])](#/sw3swsam-j-i-ifelse-is-na-sw3swsam-j-i-9-sw3swsam-j-i)
- [for(i in 1:ncol(sw5swSAM)){](#/for-i-in-1-ncol-sw5swsam)
- [for(j in 1:nrow(sw5swSAM)){](#/for-j-in-1-nrow-sw5swsam)
- [sw5swSAM[j, i] <- ifelse(is.na(sw5swSAM[j, i]), -9, sw5swSAM[j, i])](#/sw5swsam-j-i-ifelse-is-na-sw5swsam-j-i-9-sw5swsam-j-i)
- [for(i in 2:ncol(swaa2)){](#/for-i-in-2-ncol-swaa2)
- [for(j in 2:nrow(swaa2)){](#/for-j-in-2-nrow-swaa2)
- [swaa2[j, i] <- ifelse(is.na(swaa2[j, i]), -9, swaa2[j, i])](#/swaa2-j-i-ifelse-is-na-swaa2-j-i-9-swaa2-j-i)
- [swaa2[j, i] <- ifelse((swaa2[j, i]>= 0), -9, swaa2[j, i])](#/swaa2-j-i-ifelse-swaa2-j-i-0-9-swaa2-j-i)
- [saveRDS(swaal, file = "Biological Data/Ple.27.21-23_swaal.RDS")](#/saverds-swaal-file-biological-data-ple-27-21-23-swaal-rds)
- [saveRDS(mw19stdr, file("Biological Data/Ple.27.21-23_SWAA_AveStdErr_1999-2019.RDS"))](#/saverds-mw19stdr-file-biological-data-ple-27-21-23-swaa-avestderr-1999-2019-rds)
- [saveRDS(rmwstdr, file("Biological Data/Ple.27.21-23_SWAA_AveStdErr_1999-DataYear.RDS"))](#/saverds-rmwstdr-file-biological-data-ple-27-21-23-swaa-avestderr-1999-datayear-rds)
- [saveRDS(m3wstdr, file("Biological Data/Ple.27.21-23_SWAA_AveStdErr_3yr.RDS"))](#/saverds-m3wstdr-file-biological-data-ple-27-21-23-swaa-avestderr-3yr-rds)
- [rm(list = ls()[!ls() %in% k])](#/rm-list-ls-ls-in-k)
- [Table of SWAA from stock annex](#/table-of-swaa-from-stock-annex)
- [Data Prep](#/data-prep)
- [write.csv(swaasepSAM, file = "Biological Data/Ple.27.21-32_SWAA_Ave1999-2019_Value2020-Current.csv")](#/write-csv-swaasepsam-file-biological-data-ple-27-21-32-swaa-ave1999-2019-value2020-current-csv)
- [Table of SWAA for Assessment](#/table-of-swaa-for-assessment)
- [Get numbers of length samples](#/get-numbers-of-length-samples)
- [Females](#/females)
- [Males](#/males)
- [Sum of these values over lenghtclasses, by age](#/sum-of-these-values-over-lenghtclasses-by-age)
- [Calculate mean length at age](#/calculate-mean-length-at-age)
- [comb of F and M](#/comb-of-f-and-m)
- [for(i in 1:ncol(nm_SAM)){](#/for-i-in-1-ncol-nm-sam)
- [for(j in 1:nrow(nm_SAM)){](#/for-j-in-1-nrow-nm-sam)
- [nm_SAM[j, i] <- ifelse(is.na(nm_SAM[j, i]), -9, nm_SAM[j, i])](#/nm-sam-j-i-ifelse-is-na-nm-sam-j-i-9-nm-sam-j-i)
- [kable(nm_stdr,](#/kable-nm-stdr)
- [caption = "Mean mortalities by age for time invariant natural mortality in SAM.")](#/caption-mean-mortalities-by-age-for-time-invariant-natural-mortality-in-sam)
- [Based on scaling these time-invariant natural mortalities up an down, an optimised likelihood profile found that scaling all ages by a factor of 1.2 produced the best model fit. To see the details of this please see the working report, or script in the appendix.](#/based-on-scaling-these-time-invariant-natural-mortalities-up-an-down-an-optimised-likelihood-profile-found-that-scaling-all-ages-by-a-factor-of-1-2-produced-the-best-model-fit-to-see-the-details-of-this-please-see-the-working-report-or-script-in-the-appendix)
- [for(i in 1:ncol(nm_scaled)){](#/for-i-in-1-ncol-nm-scaled)
- [for(j in 1:nrow(nm_scaled)){](#/for-j-in-1-nrow-nm-scaled)
- [nm_scaled[j, i] <- ifelse(is.na(nm_scaled[j, i]), -9, nm_scaled[j, i])](#/nm-scaled-j-i-ifelse-is-na-nm-scaled-j-i-9-nm-scaled-j-i)
- [caption = "Time invariant natural mortality estimates from Gislason method scaled according to optimised likelihood profile runs.")](#/caption-time-invariant-natural-mortality-estimates-from-gislason-method-scaled-according-to-optimised-likelihood-profile-runs)
- [Define the years and number of cohorts](#/define-the-years-and-number-of-cohorts)
- [Initialize the dataframe with NA values](#/initialize-the-dataframe-with-na-values)
- [Fill the dataframe with cohort values](#/fill-the-dataframe-with-cohort-values)
- [Figure Cohorts over time from catches](#/figure-cohorts-over-time-from-catches)
- [Figure Numbers per age group over time (less intuitive than above cohort plot)](#/figure-numbers-per-age-group-over-time-less-intuitive-than-above-cohort-plot)
- [Plot](#/plot)
...
- Assessment Input Data
  - Catches broken down by:
      - subdivision
      - country
      - catch component
      - management area
  - Sampling coverage of commercial data
  - Survey Indices
  - Stock Biological Data:
      - Maturity Ogives
...
This document covers many aspects of the data in more detail and from different angles, than are strictly necessary for the assessment, but in doing so we get a better grasp of what dynamics are at play in the fishery and the stock.
...
read.ices <- function(file) {
  ...
  # ---- Header parsing ----
  # Line 1: label (ignored)
  # Line 2: format code (unused here, assumed format 1)
  # Line 3: year min/max
  # Line 4: age min/max
  # Line 5: extra code (ignored)

  format_line <- scan(text = lines[2], quiet = TRUE)
  if (format_line[1] != 1) {
    stop("Only ICES format code 1 is supported by read_ices_simple().")
  }

  years <- scan(text = lines[3], quiet = TRUE)
  ages  <- scan(text = lines[4], quiet = TRUE)
  ...
  if (length(data) != ny * na) {
    stop("Data size does not match declared year/age ranges.")
  }
  ...
  rownames(mat) <- year_min:year_max
  colnames(mat) <- age_min:age_max
...
### Landings - Results 
Over the period for which the assessment model uses catch information (2002:`r DataYear`), observers and other sampling programmes have been able to provide estimates of discarded portions of catch from various elements of the fishery.  First we consider only the landings for this period.
...
We can also visualise the landings relative to the TACs for the respective management areas that this stock straddles. Namely the North Sea management area in SD21 (Kattegat), and the Baltic Sea management area covering the remainder of the stock; SD22-32.
...
```{r eval=TRUE, fig.cap= "Landings in management areas.  The North Sea comprises just SD21 and has it's own TAC (purple lines), while the remainder of the Baltic Sea subdivisions (22:32) share a TAC."}
#===
# Figure 7 Landings in all areas by country {#figure-7-landings-in-all-areas-by-country}
#====
...
## Landings and Catches {.scrollable}
...
IC_agg_temp <- aggregate(CATON~Area,
                         data = ic_clean[ic_clean$Year == DataYear & !ic_clean$CatchCategory %in% c("BMS landing"),],
                         FUN = sum)
...
```{r fig.cap="Commercial catch by catch category aggregated to the stock level (tonnes)."}
#===
# Figure Catch by catch category (all areas, all countries) {#figure-catch-by-catch-category-all-areas-all-countries}
#====
IC_agg_temp <- ic_clean[!ic_clean$CatchCategory %in% c("BMS landing","Logbook Registered Discard", "Catch"),]
IC_agg_temp$CatchCategory <- gsub(pattern = "BMS", replacement = "Discards", x = IC_agg_temp$CatchCategory)
IC_agg_temp <- aggregate(CATON~Year+CatchCategory,
                         data = IC_agg_temp,
                         FUN = sum)

plt_stockCatch <- ggplot() +
  stat_summary(fun.y = sum,
               geom = "area",
               position = "stack",
               na.rm = TRUE,
  ...
  ylab("Catch (t)")
style(ggplotly(plt_stockCatch), showlegend = FALSE)
#====
```
...
```{r fig.cap="Commercial catch by catch category for all areas and all countries (tonnes).", fig.height=10}
#===
...
```{r fig.cap= "Discards and landings from Current year by quarter and gear", fig.height=12}
#===
# Figure Discards/landings of DataYear by quarter and gear {#figure-discards-landings-of-datayear-by-quarter-and-gear}
#====
IC_agg_temp <- ic_clean[!ic_clean$CatchCategory %in% c("BMS landing","Logbook Registered Discard", "Catch"),]
...
```{r stockSplitting}
IC_agg_temp <- ic_clean[ic_clean$Year == DataYear & !ic_clean$CatchCategory %in% c("BMS landing","Logbook Registered Discard", "Catch"),]
IC_agg_temp$CatchCategory <- gsub(pattern = "BMS", replacement = "Discards", x = IC_agg_temp$CatchCategory)
IC_agg_temp <- aggregate(CATON~Area+CatchCategory,
                         data = IC_agg_temp,
                         FUN = sum)
IC_agg_temp <- droplevels(IC_agg_temp)

IC_agg_temp <- data.frame(Subdivision = c("SD 21", "SDs 22-32"),
                          `Catch 2024` = c(sum(IC_agg_temp[IC_agg_temp$Area == "27.3.a.21", "CATON"]), sum(IC_agg_temp[IC_agg_temp$Area != "27.3.a.21", "CATON"])),
                          `Landings 2024` = c(sum(IC_agg_temp[IC_agg_temp$Area == "27.3.a.21" & IC_agg_temp$CatchCategory == "Landings", "CATON"]), sum(IC_agg_temp[IC_agg_temp$Area != "27.3.a.21" & IC_agg_temp$CatchCategory == "Landings", "CATON"])),
                          `Discards 2024` = c(sum(IC_agg_temp[IC_agg_temp$Area == "27.3.a.21" & IC_agg_temp$CatchCategory %in% c("BMS", "Discards"), "CATON"]), sum(IC_agg_temp[IC_agg_temp$Area != "27.3.a.21" & !IC_agg_temp$CatchCategory %in% c("BMS", "Discards"), "CATON"])))


kable(IC_agg_temp,
      caption = paste0("Catches and landings by management area in ", DataYear, " (tonnes). _Used for the stock splitting and history tables_."),
      digits = 2)
```
...
# Surviving discard fractions from discards and total catch - from DataCoordination Lowestoft file {#surviving-discard-fractions-from-discards-and-total-catch-from-datacoordination-lowestoft-file}
deadCatchNo<-read.ices("Assessment Input/StockAnnex/cn_mid.dat")/1000
deadcatchMeanWeight<-read.ices('Assessment Input/StockAnnex/cw_mid.dat')
deadDisMeanWeight<-read.ices('Assessment Input/StockAnnex/dw_mid.dat')
deaddf<- 1-read.ices('Assessment Input/StockAnnex/lf_mid_frac.dat')
totCatchNo <- read.ices("Assessment Input/StockAnnex/cn.dat")/1000
totcatchMeanWeight <- read.ices("Assessment Input/StockAnnex/cw.dat")
totdisMeanWeight <- read.ices("Assessment Input/StockAnnex/dw.dat")
totdf <- 1-read.ices("Assessment Input/StockAnnex/lf_frac.dat")

## Mass of catch components
deadCatchMass <- deadCatchNo*deadcatchMeanWeight
totCatchMass <- totCatchNo*totcatchMeanWeight
totDisMass <- totdisMeanWeight*totdf*totCatchNo
deadDisMass <- deadDisMeanWeight*deaddf*deadCatchNo

## Proportion of catch surviving
survCatchMassFrac <- (totCatchMass-deadCatchMass)/totCatchMass

## Proportion of discards surviving
survDisMassFrac <- (totDisMass-deadDisMass)/totDisMass

## Calculate Catch survival rates for all ages combined in DataYear
### Boil down to one number per year using masses, not numbers.
cutage<-1
low<-1
GE1<-which(as.numeric(colnames(totCatchMass))>=cutage)
E1<-which(as.numeric(colnames(totCatchMass))==cutage)
w1<-totCatchMass[,GE1]/rowSums(totCatchMass[,GE1])

catFracTot <- survCatchMassFrac
catFracTot[,E1]<-rowSums(survCatchMassFrac[,GE1]*w1)
catFracTot<-catFracTot[,low:E1]

## Calculate discard survival rates for all ages combined in DataYear
### Boil down to one number per year using masses, not numbers.
GE2<-which(as.numeric(colnames(totDisMass))>=cutage)
E2<-which(as.numeric(colnames(totDisMass))==cutage)
w2<-totDisMass[,GE2]/rowSums(totDisMass[,GE2])

disSurvTot <- survDisMassFrac
disSurvTot[,E2]<-rowSums(survDisMassFrac[,GE2]*w2)
disSurvTot<-disSurvTot[,low:E2]



```

- The catch from all subdivisions combined in `r (DataYear)` was `r sum(ic_clean[ic_clean$Year == DataYear & !ic_clean$CatchCategory %in% c("BMS landing","Logbook Registered Discard"), "CATON"])` tonnes.
  - The percentage of the total catch that were either landed or dead discards, in `r DataYear`, was `r paste0(100-(round(unname(catFracTot[names(catFracTot) == DataYear])*100, 2)), "%")`, by mass.
  - The percentage of the total catch that were surviving discards, in `r DataYear`, was `r paste0(round(unname(catFracTot[names(catFracTot) == DataYear])*100, 2), "%")`, by mass.
- The landings from all subdivisions combined in `r (DataYear)` was `r sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory == "Landings", "CATON"])` tonnes.  
...
- The discards from all subdivisions combined in `r (DataYear)` was `r sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory %in% c("Discards", "BMS"), "CATON"])` tonnes.  
  - Of these discards, `r paste0(100-(round(unname(disSurvTot[names(disSurvTot) == DataYear])*100, 2)), "%")`, by mass, were considered dead.
  - Of these discards, `r paste0(round(unname(disSurvTot[names(disSurvTot) == DataYear])*100, 2), "%")`, by mass, were considered to have survived.
  - The percentage of total discards that were taken in _active_ gears was `r ((sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory %in% c("Discards", "BMS", "BMS landing") & ic_clean$Fleet == "Active", "CATON"]))/(sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory %in% c("Discards", "BMS", "BMS landing"), "CATON"])))*100`%. 
  - The percentage of discards that were taken in _passive_ gears was `r ((sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory %in% c("Discards", "BMS", "BMS landing") & ic_clean$Fleet == "Passive", "CATON"]))/(sum(ic_clean[ic_clean$Year == DataYear & ic_clean$CatchCategory %in% c("Discards", "BMS", "BMS landing"), "CATON"])))*100`%.

The _History of commercial catch and landings_ table in the advice sheet requires that BMS official landings are subtracted from the discard values. 
```{r manualCatchCalcs, eval=TRUE}
#===
# Aggregate and format Landings and Discards for Named Countries & "Others" {#aggregate-and-format-landings-and-discards-for-named-countries-others}
#===
IC_agg_temp <- ic_clean
IC_agg_temp[IC_agg_temp$CatchCategory %in% c("BMS landing"), "CATON"] <- IC_agg_temp[ic_clean$CatchCategory == "BMS landing", "OfficialLandings.kg"]/1000
IC_agg_temp[IC_agg_temp$CatchCategory %in% c("BMS landing"), "CatchCategory"] <- "BMS"

IC_agg_temp1 <- aggregate(CATON~MgmtArea+CatchCategory+Year, data = IC_agg_temp[!IC_agg_temp$Country %in% c("Denmark", "Sweden", "Germany", "Poland"), ], FUN = "sum")
IC_agg_temp1$Country <- rep("Other", nrow(IC_agg_temp1))

IC_agg_temp <- aggregate(CATON~MgmtArea+CatchCategory+Country+Year, data = IC_agg_temp[IC_agg_temp$Country %in% c("Denmark", "Sweden", "Germany", "Poland"), ], FUN = "sum")
IC_agg_temp <- rbind(IC_agg_temp, IC_agg_temp1)

IC_agg_temp$CountryCatch <- paste0(IC_agg_temp$Country, "_", IC_agg_temp$CatchCategory)
IC_agg_temp <- IC_agg_temp[IC_agg_temp$CatchCategory %in% c("Landings", "Discards", "BMS"), c("Year", "MgmtArea", "CountryCatch", "CATON")]

# #===
# # Aggregate and format BMS Landings for all countries combined
# #===
# IC_agg_temp2 <- ic_clean[ic_clean$CatchCategory %in% c("BMS landing", "BMS"), ] {#ic-agg-temp2-ic-clean-ic-clean-catchcategory-in-c-bms-landing-bms}
# IC_agg_temp2[IC_agg_temp2$CatchCategory == "BMS landing", "CATON"] <- IC_agg_temp2[IC_agg_temp2$CatchCategory == "BMS landing", "OfficialLandings.kg"]/1000 {#ic-agg-temp2-ic-agg-temp2-catchcategory-bms-landing-caton-ic-agg-temp2-ic-agg-temp2-catchcategory-bms-landing-officiallandings-kg-1000}
# IC_agg_temp2 <- aggregate(CATON~MgmtArea+Year+, {#ic-agg-temp2-aggregate-caton-mgmtarea-year}
...
# 
# #===
# # Combine Country/catch categories and reshape to wide
# #===
# IC_agg_temp <- rbind(IC_agg_temp, IC_agg_temp2) {#ic-agg-temp-rbind-ic-agg-temp-ic-agg-temp2}
adctchtble <- reshape(data = IC_agg_temp,
                      direction = "wide",
                      timevar = c("CountryCatch"),
                      idvar = c("MgmtArea", "Year"))
...
adctchtble$CATON.Denmark_Discards <- ifelse(is.na(adctchtble$CATON.Denmark_Discards),
                                             0 - ifelse(is.na(adctchtble$CATON.Denmark_BMS), 0,
                                                        adctchtble$CATON.Denmark_BMS),
                                             adctchtble$CATON.Denmark_Discards - ifelse(is.na(adctchtble$CATON.Denmark_BMS), 0,
                                                                                        adctchtble$CATON.Denmark_BMS)
                                             )
adctchtble$CATON.Germany_Discards <- ifelse(is.na(adctchtble$CATON.Germany_Discards),
                                             0 - ifelse(is.na(adctchtble$CATON.Germany_BMS), 0,
                                                        adctchtble$CATON.Germany_BMS),
                                             adctchtble$CATON.Germany_Discards - ifelse(is.na(adctchtble$CATON.Germany_BMS), 0,
                                                                                        adctchtble$CATON.Germany_BMS)
                                             )
adctchtble$CATON.Sweden_Discards <- ifelse(is.na(adctchtble$CATON.Sweden_Discards),
                                             0 - ifelse(is.na(adctchtble$CATON.Sweden_BMS), 0,
                                                        adctchtble$CATON.Sweden_BMS),
                                             adctchtble$CATON.Sweden_Discards - ifelse(is.na(adctchtble$CATON.Sweden_BMS), 0,
                                                                                        adctchtble$CATON.Sweden_BMS)
                                             )
adctchtble$CATON.Poland_Discards <- ifelse(is.na(adctchtble$CATON.Poland_Discards),
                                             0 - ifelse(is.na(adctchtble$CATON.Poland_BMS), 0,
                                                        adctchtble$CATON.Poland_BMS),
                                             adctchtble$CATON.Poland_Discards - ifelse(is.na(adctchtble$CATON.Poland_BMS), 0,
                                                                                        adctchtble$CATON.Poland_BMS)
                                             )
adctchtble$CATON.Other_Discards <- ifelse(is.na(adctchtble$CATON.Other_Discards),
                                             0 - ifelse(is.na(adctchtble$CATON.Other_BMS), 0,
                                                        adctchtble$CATON.Other_BMS),
                                             adctchtble$CATON.Other_Discards - ifelse(is.na(adctchtble$CATON.Other_BMS), 0,
                                                                                        adctchtble$CATON.Other_BMS)
                                             )

## Calculate total BMS and catch
adctchtble$BMS <- rowSums(adctchtble[, grepl("BMS", colnames(adctchtble))],na.rm = TRUE)
adctchtble <- adctchtble[, !grepl("_BMS", colnames(adctchtble))]

adctchtble$TotalCatch <- rowSums(adctchtble[, !names(adctchtble) %in% c("Year", "MgmtArea")], na.rm = TRUE)
#=====

#===
# Add Annual Totals {#add-annual-totals}
#====
ad_tmp <- aggregate(. ~ Year, data = adctchtble[, sapply(adctchtble, is.numeric) | names(adctchtble) == "Year"],
                    FUN = function(x) if (all(is.na(x))) NA else sum(x, na.rm = TRUE), na.action = na.pass)
ad_tmp$MgmtArea <- "Areas Combined"
adctchtble <- rbind(adctchtble,ad_tmp)
...
# Do formating {#do-formating}
#===
adctchtble$MgmtArea <- ifelse(adctchtble$MgmtArea == "BalticSea", "Baltic Sea",
                              ifelse(adctchtble$MgmtArea == "NorthSea", "North Sea",
                                     ifelse(adctchtble$MgmtArea == "Areas Combined", "Areas Combined",
                                            NA)))
adctchtble$MgmtArea <- factor(adctchtble$MgmtArea, levels=)
adctchtble <- adctchtble[order(adctchtble$Year, adctchtble$MgmtArea), ]

eround <- function(y) sapply(y, function(x) if (is.na(x)) "" else if (x<1 & x>0) "<1" else round(x, 0))
adctchtble[, !names(adctchtble) %in% c("Year", "MgmtArea")] <- lapply(adctchtble[, !names(adctchtble) %in% c("Year", "MgmtArea")], FUN = eround)
...
kable(adctchtble,
      caption = paste0("Official catch numbers by country and management area for 2002-", DataYear, ".  Official landings of BMS have been subtracted from Discards. _can be copy-pasted into the advice sheet_."))
...
```{r CatchLandingDiscardSAG, eval=TRUE}
cn_full <- read.ices("Assessment Input/StockAnnex/cn.dat")/1000
cn_surv <- read.ices("Assessment Input/StockAnnex/cn_mid.dat")/1000
cw_full <- read.ices("Assessment Input/StockAnnex/cw.dat")
dw_surv <- read.ices("Assessment Input/StockAnnex/dw_mid.dat")
dw_full <- read.ices("Assessment Input/StockAnnex/dw.dat")
lw_surv <- read.ices("Assessment Input/StockAnnex/lw_mid.dat")
lf_surv <- read.ices("Assessment Input/StockAnnex/lf_mid_frac.dat")
ddf_surv <- 1-lf_surv
ddn_surv <- ddf_surv*cn_surv
ln_surv <- lf_surv*cn_surv
sdn_surv <- cn_full - (ddn_surv + ln_surv)

ddm <- ddn_surv*dw_surv
sdm <- sdn_surv*dw_full
lm <- ln_surv*lw_surv

catchSAG <- data.frame(Year = 2002:DataYear,
                       Landings = rowSums(lm),
                       DeadDiscards = rowSums(ddm),
                       SurvivingDiscards = rowSums(sdm)
                       )
rownames(catchSAG) <- NULL

kable(catchSAG,
      caption = paste0("Catches by catch category (tonnes). _Used for the catches in SAG, surviving discards as custom series_."),
      digits = 2)
```
...
```{r historyAdviceCatchManagement, eval=TRUE}


kable(catchSAG,
      caption = paste0("Catches by catch category (tonnes) and percentages surviving. _-Used for the \"History of the advice, catch, and management\" section of the advice sheet_."),
      digits = 2)
```
...
```{r fig.cap= paste0("Proportions of catch components that were sampled for biological data, and the proportion of discards that were raised by pairing with reported discard data.  Proportions are made with catch tonnage by strata (fleet, area, country, quarter) for the year ", DataYear), fig.height=8}
...
knitr::include_graphics(path = paste0("Figures/ICQ1.png"))
```
...
knitr::include_graphics(path = paste0("Figures/ICQ4.png"))
```

---

## Survey Indices {.scrollable}
...
### Natural Mortality Estimates
Prior assessments of the different components of this stock utilised the _magic numbers_ of temporally fixed natural mortality, with some rough guesses of variation across ages.  Now we use the Gislason (et al. 2010) method for estimating natural mortality based on length, $L_{\infty}$, and $K$.
$$
...
```{r fig.cap="Time and age varying natural mortality based on Gislason. Natural mortality over time, faceted by age.", fig.height=8}
...
```{r fig.cap="Time and age varying natural mortality based on Gislason. Natural mortality over ages, faceted by time.", fig.height=10}
...
To reduce the noise that comes from small samples in annual sampling, we use the same procedure as for maturity ogives and utilise a five-year, sliding window mean of this annually varying estimate, to use as input to our assessment model.
...
```{r eval=FALSE, fig.cap="Age varying, time-invariant natural mortality based on Gislason (mean values from above time series +/- 95% confidence intervals."}
...
### Catch Cohorts
Let's start with catches. First, catch cohort matrices are set up to facilitate the tracking of cohorts through time, in the visualisation (first chunk), then we plot relative numbers by age over time (second chunk).

```{r catchCohortMatrices}
# Define the years and number of cohorts {#define-the-years-and-number-of-cohorts}
...
plt_catchCohorts <- ggplot() +
  ...
  scale_y_continuous(
    breaks = function(limits) {
      seq(from = ceiling(limits[1] / 3) * 3,
          to   = floor(limits[2] / 3) * 3,
          by   = 3)}) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))
...
```{r survCohortMatrices}
# Define the years and number of cohorts
year_range <- 1992:(DataYear+1)
num_cohorts <- length(year_range)

# Initialize the dataframe with NA values
survcohorts <- data.frame(Year = year_range, matrix(NA, nrow = num_cohorts, ncol = num_cohorts))
colnames(survcohorts)[2:(num_cohorts + 1)] <- paste0("Cohort", 1:num_cohorts)
...
for (cohort in 1:num_cohorts) {
  for (age in 1:10) {
    year_index <- age + cohort - 1
    if (year_index <= num_cohorts) {
      survcohorts[year_index, cohort + 1] <- age
    }
  }
}
survcohorts$Year <- as.factor(as.character(survcohorts$Year))

k <- append(k, c("survcohorts"))
```

```{r fig.cap= "Bubble plot showing numbers (size of bubble) at age (y-axis), over time (x-axis) estimated from surveys.  The dotted lines show the progression of co-horts where large and small numbers at age can be tracked year to year.", fig.height=18}
#===
# Data Prep
#====
survcohortsLng <- reshape(data = survcohorts,
                           ...
                           timevar = "Cohort",
                           direction = "long")
survcohortsLng$Year <- as.numeric(as.character(survcohortsLng$Year))

survTunLng$Year <- as.numeric(as.character(survTunLng$Year))
survTunLng$Age <- as.numeric(as.character(survTunLng$Age))
#=====
...
');
  ...
  function addButtons() {
    ...
    tables.forEach((table, idx) => {
      if (table.dataset.csvButtonAdded) return;
      table.dataset.csvButtonAdded = '1';

      let filename = 'table_' + (idx+1) + '.csv';
      const captionEl = table.querySelector('caption');
      if (captionEl) {
        const cap = captionEl.innerText.trim();
        const m = cap.match(/Table\s+([0-9.]+)/i);
        if (m) filename = 'Table_' + m[1] + '.csv';
      }
      ...
      btn.textContent = 'Download full table (.csv)';
      btn.href = '#';
      ...
      note.style.fontSize = '0.7em';
      note.style.marginBottom = '0.8rem';
      note.textContent = 'Tip: use the slide scroll bar (or mouse wheel) to view long tables.';
  ...
  if (window.Reveal) {
    window.Reveal.on('slidechanged', addButtons);
  } else {
    setTimeout(() => window.Reveal && window.Reveal.on('slidechanged', addButtons), 1000);
  }
})();
</script>
